...
class GameInfoPanel3(object):
	def __init__(self):
		...
		self.borderTemplate = pygame.Surface((128,128))
	...
	#Surface should always be the gameInfoPanel3, basically.
	def update(self, tileType, this):
		tempText = this.dialogueFont.render(tileType, True, (0,0,0))
		width = this.dialogueFont.size(tileType)[0]
		padding = (128-width)/2
		self.titleSurf.blit(tempText, (padding,0))
		self.imageSurf.blit(eval("this.tiles."+tileType), (0,20))
		self.drawPanel()
